package com.alayon.microservices.demo.elastic.query.web.client.service;

import com.alayon.microservices.demo.config.ElasticQueryWebClientConfigData;
import com.alayon.microservices.demo.elastic.query.web.client.exception.ElasticQueryWebClientException;
...
@Service
class TwitterElasticQueryWebClient implements ElasticQueryWebClient{
    ...
    public TwitterElasticQueryWebClient(@Qualifier("webClientBuilder") final WebClient.Builder webClientBuilder,
                                        final ElasticQueryWebClientConfigData elasticQueryWebClientConfigData) {
