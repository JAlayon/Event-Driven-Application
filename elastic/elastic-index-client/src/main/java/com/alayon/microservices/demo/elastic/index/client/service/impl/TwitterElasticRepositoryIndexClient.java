...
import com.alayon.microservices.demo.elastic.index.client.repository.TwitterElasticsearchIndexRepository;
...
public class TwitterElasticRepositoryIndexClient implements ElasticIndexClient<TwitterIndexModel> {
    ...
    public TwitterElasticRepositoryIndexClient(final TwitterElasticsearchIndexRepository twitterElasticsearchIndexRepository) {
    ...
    public List<String> save(final List<TwitterIndexModel> documents) {
        final List<TwitterIndexModel> repositoryResponse = (List<TwitterIndexModel>) twitterElasticsearchIndexRepository.saveAll(documents);
        final List<String> ids = repositoryResponse
                                .stream()
