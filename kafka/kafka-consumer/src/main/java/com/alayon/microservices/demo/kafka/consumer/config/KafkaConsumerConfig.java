package com.alayon.microservices.demo.kafka.consumer.config;

import com.alayon.microservices.demo.config.KafkaConfigData;
import com.alayon.microservices.demo.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaConsumerConfig(final KafkaConfigData kafkaConfigData,
